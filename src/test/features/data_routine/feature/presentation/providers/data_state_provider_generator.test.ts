...
import { PresentStateProviderGenerator } from "../../../../../../features/data_routine/feature/presentation/providers/present_state_prov_generator";


suite('PresentProviderGenerator', () => {
  class PresentStateProviderGeneratorTest extends BaseDataRoutineGeneratorTest {

    protected createGenerator(fileSystem: IFileSystem): FileGenerator {
      return new PresentStateProviderGenerator(fileSystem);
    }
  ...
  const testInstance = new PresentStateProviderGeneratorTest();
