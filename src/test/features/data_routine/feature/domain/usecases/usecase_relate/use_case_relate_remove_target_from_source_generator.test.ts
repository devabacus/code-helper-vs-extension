...
import { useCaseRelateRemoveTargetFromSourceFileExample } from "./use_case_relate_remove_target_from_source_example";
import { UseCaseRelateRemoveTargetFromSourceGenerator } from "../../../../../../../features/data_routine/feature/domain/usecases/relate/use_case_relate_remove_target_from_source_generator";

suite('UseCaseRelateRemoveTargetFromSourceGenerator', () => {
  class UseCaseRelateRemoveTargetFromSourceGeneratorTest extends BaseDataRoutineGeneratorTest {

    protected createGenerator(fileSystem: IFileSystem): FileGenerator {
      return new UseCaseRelateRemoveTargetFromSourceGenerator(fileSystem);
    }
