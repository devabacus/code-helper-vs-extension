...
import { DataLocalSourcesGenerator } from "../../../../../../../../features/data_routine/feature/data/datasources/local/sources/local_data_source_generator";
...
suite('DataSourcesGenerator', () => {
  class DataSourcesGeneratorTest extends BaseDataRoutineGeneratorTest {
    ...
    protected createGenerator(fileSystem: IFileSystem): FileGenerator {
      return new DataLocalSourcesGenerator(fileSystem);
    }
