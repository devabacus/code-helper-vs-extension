export const TestCategoryWatchUseCaseExample = `import 'dart:async';
...
import 'package:project_name/features/feature_name/domain/usecases/category/watch_all.dart';
