  ...
  group('TaskDao', () {
    test('should create a new task', () async {
      final taskCompanion = TaskTableCompanion.insert(
        title: 'title 1', description: 'description 1', duration: 1, createdAt: DateTime(1), dueDateTime: DateTime(1), categoryId: 1
      );
    ...
    test('should get all tasks', () async {
      await taskDao.createTask(
        TaskTableCompanion.insert(title: 'title 1', description: 'description 1', duration: 1, createdAt: DateTime(1), dueDateTime: DateTime(1), categoryId: 1),
      );
      await taskDao.createTask(
        TaskTableCompanion.insert(title: 'title 2', description: 'description 2', duration: 2, createdAt: DateTime(2), dueDateTime: DateTime(2), categoryId: 2),
      );
    ...
    test('should update task', () async {
      ...
      await taskDao.updateTask(
        TaskTableCompanion(
          id: Value(1), title: Value('title 2'), description: Value('description 2'), duration: Value(2), createdAt: Value(DateTime(2)), dueDateTime: Value(DateTime(2)), categoryId: Value(2)
        ),
      );
